...
import com.example.lazismu.ketek.menu.zakat.kalkuza.KalkuzaPerdagangan;
...
public class Perdagangan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateZIS = new UpdateZIS(Perdagangan.this);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
                ...
                if (cekEditText(edhasil)) {
                    ...
                    if (data == null) {
                        ...
                        updateZIS.simpan(part_image, sharedLogin.getSharedString(SharedLogin.SP_ID), String.valueOf(value),
                                tglHariIni(), progressDialog, edhasil, "Zakat Perdagangan");
                    } else {
            ...
            case R.id.txt_kalkuza:
                dialog = new AlertDialog.Builder(Perdagangan.this);
                //buat layout
                inflater = getLayoutInflater();
                dialogView = inflater.inflate(R.layout.activity_kalkuza_perdagangan, null);
                ...
                dialog.setPositiveButton("HITUNG", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            Toast.makeText(Perdagangan.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
                    }
                });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            setTextViews(Perdagangan.this, Build.VERSION.SDK_INT, data.getData().getPath(), realPath, txtPlace, img);
            part_image = realPath;
        }
    }
