...
import com.example.lazismu.ketek.shared.SharedZIS;
...
/*
        ...
        kalkuza.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = new AlertDialog.Builder(Profesi.this);
                //buat layout
                inflater = getLayoutInflater();
                dialogView = inflater.inflate(R.layout.activity_kalkuza, null);
                ...
                edtPengeluaran = dialogView.findViewById(R.id.edpengeluaran);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            double x = zakat(Integer.parseInt(getTextEditText(edtMasukan)),
                                    Integer.parseInt(getTextEditText(edtPengeluaran)));
                            nilai = x;
                            Locale localeID = new Locale("in", "ID");
                            NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);
                            edhasil.setText(formatRupiah.format(x));
                        } catch (Exception e) {
                            Toast.makeText(Profesi.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
                    }
                });
    ...
    public double zakat(double a, double b) {
        return (a - b) * 2.5 / 100;
    }
}
