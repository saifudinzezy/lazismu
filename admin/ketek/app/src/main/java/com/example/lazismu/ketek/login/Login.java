...
import com.example.lazismu.ketek.menu.AdminItem;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedLogin.getSharedSudahLogin()) {
            ...
            //cache
            edtNo.setText(sharedLogin.getSharedString(SP_EMAIL));
    ...
    private void login(String email, final String password) {
        ...
        Call<ResponseAdmin> login = service.loginAdmin(email, password);
        login.enqueue(new Callback<ResponseAdmin>() {
            ...
            public void onResponse(Call<ResponseAdmin> call, Response<ResponseAdmin> response) {
                ...
                if (response.body().getCode() == 200) {
                    ...
                    sharedLogin.saveSharedString(SP_ID, dataUser.get(0).getIdAdmin());
