...
import com.example.lazismu.ketek.menu.AkunUser;
...
public class MainMenu extends AppCompatActivity implements BaseSliderView.OnSliderClickListener,
    ...
    @BindView(R.id.list_akun)
    FloatingActionButton listAkun;
...
//                mAuth.signOut();
//                Intent logouts = new Intent(MainMenu.this, Login.class);
...
//                finish();
    ...
    @OnClick(R.id.list_akun)
    public void onViewClicked() {
        Buka.buka(this, AkunUser.class);
    }
}
